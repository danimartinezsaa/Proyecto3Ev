...
public class GestionCitas {
    ...
    public static void anadirCita(String matricula, String fechaHora, String descripcion, float precio, String estado) {
        ...
        for (int i = 0; i < Ficheros.citas.size(); i++) { // realizamos un bucle para saber si alguna de las matriculas + horas existentes coincidde con la que queremos añadir 
            if (Ficheros.citas.get(i).getMatricula().equals(matricula) && Ficheros.citas.get(i).getFechaHora().equals(fechaHora)) { // si coincide
